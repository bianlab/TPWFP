function [sample, f_sample, im_capture, fprob_real, fprob_save, dkx, dky, kx, ky, Masks] = fun_FPM_Capture(samplename, noise, n, M_factor, fprob_flag)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
elseif strcmp(noise.type, 'pupillocation')
    ...
    im_capture = fun_A_Real(f_sample, Masks_noise, n/M_factor, n/M_factor, fmaskpro);
    im_capture = abs(im_capture).^2;
end
