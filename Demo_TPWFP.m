...
if isfield(Params, 'alpha_h')     == 0,  Params.alpha_h     = 25;    end
if isfield(Params, 'tau0')        == 0,  Params.tau0        = 330;  end     % Time constant for step size
if isfield(Params, 'muTWF')       == 0,  Params.muTWF       = 0.1;  end     % step size of TWF
if isfield(Params, 'T')           == 0,  Params.T           = 300;  end    	% number of iterations
